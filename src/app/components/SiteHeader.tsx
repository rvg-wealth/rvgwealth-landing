          ...
          {navItems.map((item) => {
            ...
            return (
              <a
                ...
                className={
                  isActive
                    ? "font-serif tracking-tight text-sm uppercase font-medium text-[#4F6352] border-b border-[#4F6352] pb-1"
                    : "font-serif tracking-tight text-sm uppercase font-medium text-[#4F6352]/60 hover:text-[#4F6352] hover:opacity-100 transition-all duration-500"
                }
                href={item.href}
              >
                {item.label}
